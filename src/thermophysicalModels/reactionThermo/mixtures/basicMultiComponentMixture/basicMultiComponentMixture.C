...
Foam::basicMultiComponentMixture<ThermoType>::readSpeciesData
(
...
template<class ThermoType>
typename Foam::basicMultiComponentMixture<ThermoType>::speciesCompositionTable
Foam::basicMultiComponentMixture<ThermoType>::readSpeciesComposition
(
    const dictionary& thermoDict,
...
template<class ThermoType>
Foam::basicMultiComponentMixture<ThermoType>::basicMultiComponentMixture
(
    const dictionary& thermoDict,
    const fvMesh& mesh,
...
template<class ThermoType>
void Foam::basicMultiComponentMixture<ThermoType>::read
(
    const dictionary& thermoDict
)
{
