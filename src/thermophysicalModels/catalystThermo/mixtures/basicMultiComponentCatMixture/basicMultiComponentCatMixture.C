...
Foam::basicMultiComponentCatMixture<ThermoType>::readSpeciesData
(
...
template<class ThermoType>
typename Foam::basicMultiComponentCatMixture<ThermoType>::speciesCompositionTable
Foam::basicMultiComponentCatMixture<ThermoType>::readSpeciesComposition
(
    const dictionary& thermoDict,
...
template<class ThermoType>
Foam::basicMultiComponentCatMixture<ThermoType>::basicMultiComponentCatMixture
(
    const dictionary& thermoDict,
    const fvMesh& mesh,
...
template<class ThermoType>
void Foam::basicMultiComponentCatMixture<ThermoType>::read
(
    const dictionary& thermoDict
)
{
