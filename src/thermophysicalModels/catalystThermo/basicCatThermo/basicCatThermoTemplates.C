...
typename Table::iterator Foam::basicCatThermo::lookupThermo
(
...
{
    if (thermoDict.isDict("solidThermoType"))
    {
        const dictionary& solidThermoTypeDict(thermoDict.subDict("solidThermoType"));

        Info<< "Selecting thermodynamics package for solid part of catalyst" 
            << solidThermoTypeDict << endl;
        ...
        const word thermoTypeName
        (
            word(solidThermoTypeDict.lookup("solidType")) + '<'
          + word(solidThermoTypeDict.lookup("solidMixture")) + '<'
          + word(solidThermoTypeDict.lookup("solidTransport")) + '<'
          + word(solidThermoTypeDict.lookup("solidThermo")) + '<'
          + word(solidThermoTypeDict.lookup("solidEquationOfState")) + '<'
          + word(solidThermoTypeDict.lookup("solidSpecie")) + ">>,"
          + word(solidThermoTypeDict.lookup("solidEnergy")) + ">>>"
        );
...
Foam::autoPtr<Thermo> Foam::basicCatThermo::New
(
    const fvMesh& mesh,
