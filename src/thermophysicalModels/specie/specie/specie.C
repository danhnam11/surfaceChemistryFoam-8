...
:
    ...
    Ys_(dict.subDict("specie").lookupOrDefault("siteFraction", 1.0)), //
    siteDensity_(dict.subDict("specie").lookupOrDefault("siteDensity", 1.0)), //
    siteNumber_(dict.subDict("specie").lookupOrDefault("siteNumber", 1)) //    
{}
