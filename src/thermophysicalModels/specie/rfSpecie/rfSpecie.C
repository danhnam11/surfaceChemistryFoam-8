...
:
    ...
    */
    ...
    Tc_(dict.subDict("dataForRealGas").lookup<scalar>("Tc")),
    Pc_(1e6*dict.subDict("dataForRealGas").lookup<scalar>("Pc")),
    Vc_(dict.subDict("dataForRealGas").lookup<scalar>("Vc")),
    omega_(dict.subDict("dataForRealGas").lookup<scalar>("omega")),
    kappai_(dict.subDict("dataForRealGas").lookup<scalar>("kappai")),
    miui_(dict.subDict("dataForRealGas").lookup<scalar>("miui")),
    sigmvi_(dict.subDict("dataForRealGas").lookup<scalar>("sigmvi"))
{}
