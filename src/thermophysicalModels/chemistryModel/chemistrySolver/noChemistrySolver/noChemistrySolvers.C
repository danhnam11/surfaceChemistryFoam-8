...
namespace Foam
{
    forDTMGases(makeChemistrySolvers, noChemistrySolver, psiReactionThermo); //
    forDTMGases(makeChemistrySolvers, noChemistrySolver, rhoReactionThermo); //

    forFTMGases(makeChemistrySolvers, noChemistrySolver, psiReactionThermo); //
    forFTMGases(makeChemistrySolvers, noChemistrySolver, rhoReactionThermo); //
