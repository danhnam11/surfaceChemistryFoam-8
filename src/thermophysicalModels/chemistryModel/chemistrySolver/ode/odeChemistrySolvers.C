...
namespace Foam
{
    forDTMGases(makeChemistrySolvers, ode, psiReactionThermo); //
    forDTMGases(makeChemistrySolvers, ode, rhoReactionThermo); //

    forFTMGases(makeChemistrySolvers, ode, psiReactionThermo); //
    forFTMGases(makeChemistrySolvers, ode, rhoReactionThermo); //
