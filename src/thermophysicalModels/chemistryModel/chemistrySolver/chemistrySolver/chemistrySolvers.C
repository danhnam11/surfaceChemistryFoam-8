...
namespace Foam
{
    ...
    forDTMGases(defineChemistrySolvers, psiReactionThermo); //
    forDTMGases(defineChemistrySolvers, rhoReactionThermo); //

    forFTMGases(defineChemistrySolvers, psiReactionThermo); //
    forFTMGases(defineChemistrySolvers, rhoReactionThermo); //
