...
namespace Foam
{
    ...
    forDTMGases(makeChemistrySolvers, EulerImplicit, psiReactionThermo); //
    forDTMGases(makeChemistrySolvers, EulerImplicit, rhoReactionThermo); //

    forFTMGases(makeChemistrySolvers, EulerImplicit, psiReactionThermo); //
    forFTMGases(makeChemistrySolvers, EulerImplicit, rhoReactionThermo); //
