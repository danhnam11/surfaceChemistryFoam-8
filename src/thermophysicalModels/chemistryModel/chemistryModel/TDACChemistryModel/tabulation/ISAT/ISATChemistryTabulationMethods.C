...
namespace Foam
{
    ...
    forDTMGases(makeChemistryTabulationMethod, ISAT, psiReactionThermo);
    forDTMGases(makeChemistryTabulationMethod, ISAT, rhoReactionThermo);

    forFTMGases(makeChemistryTabulationMethod, ISAT, psiReactionThermo);
    forFTMGases(makeChemistryTabulationMethod, ISAT, rhoReactionThermo);
