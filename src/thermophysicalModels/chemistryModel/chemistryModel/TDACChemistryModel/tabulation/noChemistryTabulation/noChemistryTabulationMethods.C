...
namespace Foam
{
    ...
    forDTMGases(makeChemistryTabulationMethod, none, psiReactionThermo);
    forDTMGases(makeChemistryTabulationMethod, none, rhoReactionThermo);

    forFTMGases(makeChemistryTabulationMethod, none, psiReactionThermo);
    forFTMGases(makeChemistryTabulationMethod, none, rhoReactionThermo);
