...
namespace Foam
{
    ...
    forDTMGases(defineChemistryTabulationMethod, psiReactionThermo);
    forDTMGases(defineChemistryTabulationMethod, rhoReactionThermo);

    forFTMGases(defineChemistryTabulationMethod, psiReactionThermo);
    forFTMGases(defineChemistryTabulationMethod, rhoReactionThermo);
