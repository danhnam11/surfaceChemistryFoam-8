...
namespace Foam
{
    ...
    forDTMGases(makeChemistryReductionMethod, DAC, psiReactionThermo);
    forDTMGases(makeChemistryReductionMethod, DAC, rhoReactionThermo);

    forFTMGases(makeChemistryReductionMethod, DAC, psiReactionThermo);
    forFTMGases(makeChemistryReductionMethod, DAC, rhoReactionThermo);
