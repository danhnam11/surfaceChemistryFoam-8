...
namespace Foam
{
    ...
    forDTMGases(makeChemistryReductionMethod, EFA, psiReactionThermo);
    forDTMGases(makeChemistryReductionMethod, EFA, rhoReactionThermo);

    forFTMGases(makeChemistryReductionMethod, EFA, psiReactionThermo);
    forFTMGases(makeChemistryReductionMethod, EFA, rhoReactionThermo);
