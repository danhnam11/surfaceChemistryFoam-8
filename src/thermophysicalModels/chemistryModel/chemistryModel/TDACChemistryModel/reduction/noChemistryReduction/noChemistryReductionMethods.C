...
namespace Foam
{
    ...
    forDTMGases(makeChemistryReductionMethod, none, psiReactionThermo);
    forDTMGases(makeChemistryReductionMethod, none, rhoReactionThermo);

    forFTMGases(makeChemistryReductionMethod, none, psiReactionThermo);
    forFTMGases(makeChemistryReductionMethod, none, rhoReactionThermo);
