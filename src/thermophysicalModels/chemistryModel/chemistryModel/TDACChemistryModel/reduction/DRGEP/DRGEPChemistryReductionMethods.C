...
namespace Foam
{
    ...
    forDTMGases(makeChemistryReductionMethod, DRGEP, psiReactionThermo);
    forDTMGases(makeChemistryReductionMethod, DRGEP, rhoReactionThermo);

    forFTMGases(makeChemistryReductionMethod, DRGEP, psiReactionThermo);
    forFTMGases(makeChemistryReductionMethod, DRGEP, rhoReactionThermo);
