...
namespace Foam
{
    ...
    forDTMGases(makeChemistryReductionMethod, DRG, psiReactionThermo);
    forDTMGases(makeChemistryReductionMethod, DRG, rhoReactionThermo);

    forFTMGases(makeChemistryReductionMethod, DRG, psiReactionThermo);
    forFTMGases(makeChemistryReductionMethod, DRG, rhoReactionThermo);
