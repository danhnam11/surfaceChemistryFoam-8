...
namespace Foam
{
    ...
    forDTMGases(makeChemistryReductionMethod, PFA, psiReactionThermo);
    forDTMGases(makeChemistryReductionMethod, PFA, rhoReactionThermo);

    forFTMGases(makeChemistryReductionMethod, PFA, psiReactionThermo);
    forFTMGases(makeChemistryReductionMethod, PFA, rhoReactionThermo);
