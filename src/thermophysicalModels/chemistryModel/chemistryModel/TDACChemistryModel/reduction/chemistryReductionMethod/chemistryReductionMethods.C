...
namespace Foam
{
    ...
    forDTMGases(defineChemistryReductionMethod, psiReactionThermo);
    forDTMGases(defineChemistryReductionMethod, rhoReactionThermo);

    forFTMGases(defineChemistryReductionMethod, psiReactionThermo);
    forFTMGases(defineChemistryReductionMethod, rhoReactionThermo);
