...
)
{
    ...
    (
        ...
        (
          ...
          ? "TDAC"
          : chemistryTypeDict.lookupOrDefault<bool>("DTMStandard", false) //Nam
          ? "DTMStandard"  //Nam
          : chemistryTypeDict.lookupOrDefault<bool>("PPStandard", false) //Nam
          ? "PPStandard"  //Nam
          : chemistryTypeDict.lookupOrDefault<bool>("FTMStandard", false) //Nam
          ? "FTMStandard"  //Nam
          : chemistryTypeDict.lookupOrDefault<bool>("SRKchungTakaStandard", false) //Nam
          ? "SRKchungTakaStandard"  //Nam
          : chemistryTypeDict.lookupOrDefault<bool>("PRchungTakaStandard", false) //Nam
          ? "PRchungTakaStandard"  //Nam
          : chemistryTypeDict.lookupOrDefault<bool>("SRKchungKineticStandard", false) //Nam
          ? "SRKchungKineticStandard"  //Nam
          : chemistryTypeDict.lookupOrDefault<bool>("PRchungKineticStandard", false) //Nam
          ? "PRchungKineticStandard"  //Nam
          : chemistryTypeDict.lookupOrDefault<bool>("idKineticStandard", false) //Nam
          ? "idKineticStandard"  //Nam
          : "standard"
        )
    );
