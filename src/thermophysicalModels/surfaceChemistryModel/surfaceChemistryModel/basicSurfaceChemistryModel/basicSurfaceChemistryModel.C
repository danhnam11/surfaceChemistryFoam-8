...
namespace Foam
{
    defineTypeNameAndDebug(basicSurfaceChemistryModel, 0);
}

// * * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * //

void Foam::basicSurfaceChemistryModel::correct()
{}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::basicSurfaceChemistryModel::basicSurfaceChemistryModel
(
    basicThermo& thermo,
    basicCatThermo& catThermo    
)
:
    IOdictionary
    (
